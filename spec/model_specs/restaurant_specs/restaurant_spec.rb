...
RSpec.describe Restaurant, type: :model do
  describe 'restaurant should have validations' do
    ...
    it 'Restaurant should not be valid without user' do
    ...
    it 'restaurant should not be valid without a name' do
    ...
    it 'restaurant should not be valid without an address' do
    ...
    it 'should be valid with name, address, speciality and user' do
